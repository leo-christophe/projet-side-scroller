...
image_player_right = pygame.image.load("assets/player_right_1.png")
image_player_left = pygame.image.load("assets/player_left_1.png")
...
Player.rect.x = Player.size[1]
Player.rect.y = 720 - 150 - Player.size[1]
