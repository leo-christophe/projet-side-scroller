...
bg = pygame.image.load("assets/textures/background/fond_plaines.png").convert()
...
all_platforms.append(fond_plaine_plateforme_pos)
...
def music():
    if music_playing == True: #jouer de la musique
