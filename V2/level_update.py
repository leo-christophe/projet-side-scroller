...
class Plains():
    ...
    def __init__(self, subzone, fenetre, current_player):
        ...
        self.fond_plaine_plateforme = pygame.image.load("assets/textures/background/fond_plaines_plateforme.png")
        self.plat1rect = self.fond_plaine_plateforme.get_rect()
        self.plat1rect.y = 600
        self.plat2rect = self.fond_plaine_plateforme.get_rect()
        self.plat2rect.y = 600
        self.plat2rect.x = 345
        self.plat3rect = self.fond_plaine_plateforme.get_rect()
        self.plat3rect.y = 450
        self.plat3rect.x = 400
        self.fenetre = fenetre
        self.player = current_player
        self.last_zone = 8
        self.collisions = [self.plat1rect, self.plat2rect, self.plat3rect]
    ...
    def subzone_0(self):
        ...
        fenetre.blit(self.fond_plaine_plateforme, (self.plat1rect.x, self.plat1rect.y))   
        fenetre.blit(self.fond_plaine_plateforme, (self.plat2rect.x, self.plat2rect.y))        
        fenetre.blit(self.fond_plaine_plateforme, self.plat3rect)           
        
    def subzone_1(self):
        self.collisions = [self.plat1rect]
        fenetre = self.fenetre
        self.window_refreshing(fenetre)
    ...
    def subzone_2(self):
        ...
        fenetre.blit(self.bg, (0, 0))
        redrawWindow(self.fenetre, self.player)
        fenetre.blit(self.fond_plaine_plateforme, self.plat1rect)
